    ...
    <Fade bottom duration={1000} distance="40px">
      <div className="greet-main" id="greeting">
        <div className="greeting-main">
          ...
          {/* KOD BAHARU (Gantikan dengan ini): */}
<div className="greeting-image-div" style={{ display: "flex", justifyContent: "center", paddingLeft: window.innerWidth > 768 ? "40px" : "0px", boxSizing: "border-box" }}>
  <div className="profile-image-container-xl" style={{ marginLeft: window.innerWidth > 768 ? "20px" : "0px" }}>
    <img
